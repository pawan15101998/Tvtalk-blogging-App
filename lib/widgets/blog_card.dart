...
class _BlogCardState extends State<BlogCard> {
  ...
  return InkWell(
  //   onTap: () async{
  //     context.pushNamed('ARTICLEDETAILPAGE',extra: blogDetail, queryParams: {"index": "$indexx"});
  ...
  //   },
          ...
          InkWell(
            onTap: () async{
              if(signincontroller.isGuest.value == 'guest'){
               ...
               context.pushNamed('ARTICLEDETAILPAGE',extra: widget.blogDetail, queryParams: {"index": "${widget.indexx}"});
            }
    final SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
   ...
   isRead = await apiprovider.postApi('/post/mark-read', {
    'postId': "${widget.blogDetail.id}"
   });
   print(allldata);
    },
             child: Container(
