...
class ArticleDetailPage extends StatefulWidget {
  dynamic postData;
  Map feedindex;
  ArticleDetailPage({Key? key, this.postData, required this.feedindex})
      : super(key: key);
...
class _ArticleDetailPageState extends State<ArticleDetailPage> {
  ...
  Stream streamController() =>
      Stream.fromFuture(apiprovider.getComment(widget.postData.id));
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      homepage1controller
                                          .copydata[pageindex].title.rendered,
                              ...
                              CarouselSlider.builder(
                                options: CarouselOptions(
                                    ...
                                    onPageChanged: ((index, reason) {
                                      // homePage1 = index;
                                      detailpageController.DetailScroll.value =
                                          index;
                                    })),
                                itemCount: urlImages.length,
                                itemBuilder: ((context, index, realIndex) {
                                  final urlImage = urlImages[index];
                                  return buildSimilarImage(
                                      urlImage, index, context);
                                }),
                              ),
                              const SizedBox(
                                height: 20,
                      ...
                      if (detailpageController.commentData!.data!.comments !=
                        ...
                        InkWell(
                          ...
                          child: SizedBox(
                              height: 20,
                              width: 20,
                              child: detailpageController.commentData!.data!
                                          .comments!.rows![0].commentLikes !=
                                      0
                                  ? Image(
                                      image: AssetImage(
                      ...
                      InkWell(
                        ...
                        child: SizedBox(
                            ...
                            child: Image(
                              ...
                              color: detailpageController.isDark.value == true
                                  ? Colors.white
                                  : Colors.black,
                            )),
                      ),
                          ...
                          onTap: () async {
                            ...
                            if (apiprovider.RegisterResponse['message'] ==
                              ...
                              final snackBar = SnackBar(
                                ...
                                content: const Text("Replay add sucessfully"),
