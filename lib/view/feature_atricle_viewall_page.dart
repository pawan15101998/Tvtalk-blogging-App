...
class FeatureArticleViewAll extends StatefulWidget {
  const FeatureArticleViewAll(
      ...
      : super(key: key);
  @override
  State<FeatureArticleViewAll> createState() => _FeatureArticleViewAllState();
}
...
class _FeatureArticleViewAllState extends State<FeatureArticleViewAll> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          title: const Text("Feature Article"),
