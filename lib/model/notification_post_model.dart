...
//
//     final notificationPostPage = notificationPostPageFromJson(jsonString);

import 'dart:convert';

List<NotificationPostPage> notificationPostPageFromJson(String str) => List<NotificationPostPage>.from(json.decode(str).map((x) => NotificationPostPage.fromJson(x)));

String notificationPostPageToJson(List<NotificationPostPage> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class NotificationPostPage {
    ...
    factory NotificationPostPage.fromJson(Map<String, dynamic> json) => NotificationPostPage(
        id: json["id"],
